<form action="" class="form-inline">
    ...
    <div class="form-group">
    <input type="text" name="start_range" id="start_range" class="form-control form-control-sm" value="{!! \Session::get('dateRange')['start_range'] ?? date('Y-m-d') !!}">
    </div>
    <div class="form-group">
    <input type="text" name="end_range" id="end_range" class="form-control form-control-sm" value="{!! \Session::get('dateRange')['end_range'] ?? date('Y-m-d') !!}">
    </div>
